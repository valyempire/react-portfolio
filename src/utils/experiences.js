...
export const experiences = [
  {
    ...
    courses: [
      ...
      "- Complete Web Developer 2023 by Andrei Neagoie",
      "- Advanced Javascript Course by Andrei Neagoie",
      "- React 18: Intermediate Topics by Mosh Hamedani",
    ],
    skills: [
      "HTML",
      "CSS",
  ...
  },
  {
    ...
    skills: ["HTML", "CSS", "JavaScript", "React", "GitHub", "Git"],
